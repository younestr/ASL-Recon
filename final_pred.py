...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:\\Users\\hp\\Downloads\\MachineLearning\\Sign-Language-To-Text-and-Speech-Conversion-master\\cnn8grps_rad1_model.h5')
        ...
        self.panel.place(x=50, y=50, width=640, height=480)  # Increased dimensions for better visibility

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=550, y=50, width=300, height=300)

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=10)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 20, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=50, y=420)
        ...
        self.panel5.place(x=50, y=500)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=50, y=540)
        ...
        self.b1.place(x=50, y=620)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=200, y=620)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=350, y=620)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=500, y=620)

        self.speak = tk.Button(self.root)
        self.speak.place(x=650, y=620)
    ...
    def video_loop(self):
        try:
            ...
            if hands and hands[0]:
                # Loading JSON
                handsT = json.dumps(hands[0])
                hand = json.loads(handsT)
                ...
                white = cv2.imread("C:\\Users\\hp\\Downloads\\MachineLearning\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
